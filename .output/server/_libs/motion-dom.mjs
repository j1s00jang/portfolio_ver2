import { M as MotionGlobalConfig, r as noop, f as clamp, s as pipe, q as millisecondsToSeconds, v as secondsToMilliseconds, w as velocityPerSecond, j as invariant, t as progress, l as isEasingArray, h as easingDefinitionToFunction, g as easeInOut, p as memo, k as isBezierDefinition, d as circInOut, c as backInOut, b as anticipate, m as isNumericalString, S as SubscriptionManager, o as isZeroValueString, n as isObject, e as circOut, a as addUniqueItem, u as removeItem } from "./motion-utils.mjs";
const stepsOrder = [
  "setup",
  // Compute
  "read",
...
export {
  scrapeMotionValuesFromProps$1 as $,
  isForcedMotionValue as A,
  isGenerator as B,
  isHTMLElement as C,
  isMotionValue as D,
  isPrimaryPointer as E,
  Feature as F,
  GroupAnimationWithThen as G,
  HTMLProjectionNode as H,
  isSVGElement as I,
  isSVGSVGElement as J,
  isSVGTag as K,
  isVariantLabel as L,
  isVariantNode as M,
  measurePageBox as N,
  ObjectVisualElement as O,
  microtask as P,
  mixNumber$1 as Q,
  motionValue as R,
  SVGVisualElement as S,
  optimizedAppearDataAttribute as T,
  percent as U,
  press as V,
  resize as W,
  resolveElements as X,
  resolveMotionValue as Y,
  resolveVariant as Z,
  resolveVariantFromProps as _,
  HTMLVisualElement as a,
  scrapeMotionValuesFromProps as a0,
  setDragLock as a1,
  setFeatureDefinitions as a2,
  spring as a3,
  visualElementStore as a4,
  addDomEvent as b,
  addValueToWillChange as c,
  animateMotionValue as d,
  animateSingleValue as e,
  animateTarget as f,
  buildHTMLStyles as g,
  buildSVGAttrs as h,
  calcLength as i,
  cancelFrame as j,
  ...
  createBox as n,
  createGeneratorEasing as o,
  defaultOffset as p,
  eachAxis as q,
  fillOffset as r,
  frame as s,
  frameData as t,
  getFeatureDefinitions as u,
