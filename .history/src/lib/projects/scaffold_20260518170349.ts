...
export const scaffold: Project = {
    ...
    caseStudySections: {
        ...
        "learning-outcomes": [
            ...
            "**1. Team collaboration and communication:** Working with 6 team members from all different perspectives to deliver a project from start to finish.",
            "**2. Research-to-product thinking:** turning insight into priorities, then into flows and UI decisions",
            "**3. End-to-end UX execution:** IA → wireframes → UI system → prototype + live demo",
            "**4. Storytelling:** pitching sharpened structured thinking and message delivery",

            "**Scaffold’s next steps:** to expand into more grants and regions, and to add more features, such as keeping personal documents secure in the app so users can apply directly from the app and track the process. Scaffold’s core proposition will always be to help tradespeople find financial support, **because no one should pause or stop a career path due to a lack of accessible financial support.**",
            "**Resources exist, Roadblocks don’t have to.**",
        ],
    },
