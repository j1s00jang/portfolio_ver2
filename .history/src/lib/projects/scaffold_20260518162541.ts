...
export const scaffold: Project = {
    ...
    caseStudySections: {
        ...
        "print-design": [
            ...
            "1. Eligibility Quiz: Help users find eligible grants based on their profile.",
            "2. Grant List: Show all eligible grants in one place.",
            "3. Grant Details: Show detailed information about each grant.",
            "4. Grant Application: Help users apply for a grant.",
            "5. Grant Tracking: Help users track their grant application status.",
        ],
    },
