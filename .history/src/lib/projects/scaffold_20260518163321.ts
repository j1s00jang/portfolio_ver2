...
export const scaffold: Project = {
    ...
    caseStudySections: {
        ...
        "learning-outcomes": [
            ...
            "**Time saved (timed usability test, n=5):** Traditional workflow average **112 min** (Google search → eligibility review → application drafting). With Scaffold average is **15 min**, including creating a profile and applying eligible grants. **3m** to re-applying eligible grants, excluding essay writing",
            "**Reduction:** From **112 min** to **15 min** (**86.6% faster**) using the same grant scenario",
            "Scaffold project taught me:",
