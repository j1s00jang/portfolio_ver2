...
export const scaffold: Project = {
    ...
    caseStudySections: {
        ...
        "learning-outcomes": [
            "The learning outcomes were designed to be simple and clear. The key message is that Scaffold helps tradespeople find financial support to continue their career path.",
            "The learning outcomes are designed to be simple and clear. The key message is that Scaffold helps tradespeople find financial support to continue their career path.",
            "The learning outcomes are designed to be simple and clear. The key message is that Scaffold helps tradespeople find financial support to continue their career path.",
        ],
    },
