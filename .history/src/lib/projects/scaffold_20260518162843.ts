...
export const scaffold: Project = {
    ...
    caseStudySections: {
        ...
        "product-storytelling": [
            "Scaffold’s promotional video was created to showcase strong product storytelling from insight to narrative. The concept was built from a research-backed moment: **a skilled tradeswoman was able to keep career without giving up because of financial struggles.**",
            "The storytelling is designed to be simple and clear. The key message is thatA complete storyboard and script were developed independently to translate that insight into a clear, emotionally grounded story angle. The final video premiered on pitch day in front of 300 attendees to introduce the app concept and reinforce Scaffold’s core message: Resources exist, Roadblocks don’t have to.",
        ],
    },
