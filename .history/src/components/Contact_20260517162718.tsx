...
const links = [
  ...
  { label: "LinkedIn", href: "https://www.linkedin.com/in/jisoojang", icon: Linkedin, external: true },
  { label: "Email", href: `mailto:${email}`, icon: Mail, external: false },
  { label: "Instagram", href: "https://www.instagram.com/jisoo.design", icon: Instagram, external: true },
];
    ...
    >
      <div className="mx-auto max-w-[1440px]">
        <div className="mb-14 flex items-baseline justify-between">
          <h2 className="font-mono text-xs uppercase tracking-[0.2em] text-muted-foreground">Contact</h2>
