...
export const scaffoldSections: Section[] = [
  ...
  { num: "11", label: "Learning Outcomes & Next Steps", id: "learning-outcomes" },
];
            ...
            <li key={s.id}>
              ...
              >
                ...
                <span className="overflow-hidden inline-block w-48">
                  <span
                    className="block transition-[transform,opacity] duration-500 ease-out -translate-x-6 opacity-0 group-hover/nav:translate-x-0 group-hover/nav:opacity-100 will-change-transform"
                  >
                    {s.label}
                  </span>
                </span>
