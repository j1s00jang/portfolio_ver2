    ...
    for (const block of blocks) {
        if (typeof block === "string") {
            ...
            out.push(
                ...
                >
                    <span className="rounded-sm bg-accent px-1.2 py-1.2 font-semibold text-accent-foreground [box-decoration-break:clone] md:px-2 md:py-2 [&_strong]:text-accent-foreground">
