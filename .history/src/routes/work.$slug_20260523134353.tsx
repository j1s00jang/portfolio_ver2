    ...
    for (const block of blocks) {
        if (typeof block === "string") {
            ...
            out.push(
                ...
                >
                    <span className="rounded-sm bg-accent px-1.5 py-1.5 font-semibold text-accent-foreground [box-decoration-break:clone] md:px-2 md:py-2 [&_strong]:text-accent-foreground">
